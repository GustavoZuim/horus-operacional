...
elements.append(Paragraph("Matr??cula: MG38", styles['Normal']))
elements.append(Spacer(1, 0.3*cm))

# Segunda-feira (normal)
elements.append(Paragraph("<b>Segunda-feira</b>", styles['Heading3']))
elements.append(Paragraph("Organiza????o Cadastral", styles['Normal']))
...
elements.append(Paragraph("Valida????o do portal do aluno", styles['Normal']))
...
elements.append(Paragraph("Elabora????o de Relat??rios", styles['Normal']))
elements.append(Paragraph("Relat??rio mensal de atividades", styles['Normal']))
elements.append(Paragraph("Sem Unidade", styles['Normal']))
elements.append(Spacer(1, 0.5*cm))

# Dados Rian
elements.append(Paragraph("<b>Rian Gabriel Oliveira Miguel</b>", styles['Heading2']))
elements.append(Paragraph("Matr??cula: MG37", styles['Normal']))
elements.append(Spacer(1, 0.3*cm))
...
elements.append(Paragraph("<b>Quinta-feira</b>", styles['Heading3']))
elements.append(Paragraph("Forma????o e Treinamento", styles['Normal']))

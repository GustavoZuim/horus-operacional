...
# TÜtulo
title = Paragraph("<b>Planejamento Semanal - Escola Online GuarÜ - Semana 26</b>", styles['Title'])
elements.append(title)
elements.append(Spacer(1, 0.5*cm))

# PerÜodo
period = Paragraph("PerÜodo: 17/06/2026 a 21/06/2026", styles['Normal'])
...
elements.append(Paragraph("AtualizaÜÜo dos cadastros de alunos no sistema", styles['Normal']))
elements.append(Paragraph("Sem Unidade", styles['Normal']))
elements.append(Spacer(1, 0.3*cm))

# TerÜa-feira (FERIADO)
elements.append(Paragraph("<b>TerÜa-feira</b>", styles['Heading3']))
...
elements.append(Paragraph("Folga compensatÜria do final de semana", styles['Normal']))
elements.append(Paragraph("Sem Unidade", styles['Normal']))
elements.append(Spacer(1, 0.3*cm))
...
elements.append(Paragraph("<b>Quarta-feira</b>", styles['Heading3']))
elements.append(Paragraph("Teste de Funcionalidades", styles['Normal']))
elements.append(Paragraph("Testes de integraÜÜo", styles['Normal']))
...
elements.append(Paragraph("CapacitaÜÜo de professores", styles['Normal']))
...
elements.append(Paragraph("Dia nÜo letivo - planejamento pedagÜgico", styles['Normal']))
elements.append(Paragraph("Sem Unidade", styles['Normal']))

doc.build(elements)
print(f'Ü? PDF criado: {pdf_path}')
print('\nConteÜdo:')
print('- Mara: Segunda (normal), TerÜa (FERIADO), Quarta (normal), Quinta (FOLGA), Sexta (normal)')
print('- Rian: Segunda (normal), TerÜa (FERIADO), Quarta (normal), Quinta (normal), Sexta (RECESSO)')

...
# Período
period = Paragraph("Período: 17/06/2026 a 21/06/2026", styles['Normal'])
...
elements.append(Paragraph("Atualização dos cadastros de alunos no sistema", styles['Normal']))
elements.append(Paragraph("Sem Unidade", styles['Normal']))
elements.append(Spacer(1, 0.3*cm))

# Terça-feira (FERIADO)
elements.append(Paragraph("<b>Terça-feira</b>", styles['Heading3']))
...
elements.append(Paragraph("Folga compensatória do final de semana", styles['Normal']))
elements.append(Paragraph("Sem Unidade", styles['Normal']))
elements.append(Spacer(1, 0.3*cm))
...
elements.append(Paragraph("<b>Quarta-feira</b>", styles['Heading3']))
elements.append(Paragraph("Teste de Funcionalidades", styles['Normal']))
elements.append(Paragraph("Testes de integração", styles['Normal']))
...
elements.append(Paragraph("Capacitação de professores", styles['Normal']))
...
elements.append(Paragraph("Dia não letivo - planejamento pedagÜgico", styles['Normal']))
elements.append(Paragraph("Sem Unidade", styles['Normal']))

doc.build(elements)
print(f'✓ PDF criado: {pdf_path}')
print('\nConteÜdo:')
print('- Mara: Segunda (normal), Terça (FERIADO), Quarta (normal), Quinta (FOLGA), Sexta (normal)')
print('- Rian: Segunda (normal), Terça (FERIADO), Quarta (normal), Quinta (normal), Sexta (RECESSO)')
